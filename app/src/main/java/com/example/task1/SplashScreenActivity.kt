...
import com.example.task1.databinding.ActivitySplashScreenBinding
...
class SplashScreenActivity : AppCompatActivity() {
    ...
    private fun transactToMenuActivity() {
    ...
    private fun startAnimation(lottieAnimationView: LottieAnimationView) {
        ...
        lottieAnimationView.postDelayed({ transactToMenuActivity() }, 2000)
